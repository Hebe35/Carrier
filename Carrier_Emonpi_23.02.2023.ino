...
// check if returns are valid, if they are NaN (not a number) then something went wrong!
  ...
  // Set the mode based on the outdoor temperature (summer cooling)
   if (outdoor >= 20 &&  aircond_intake >= 23 && outdoor < 100 && aircond_intake < 100 && outdoor != 127 && aircond_intake != 127) {
    operatingMode = MODE_COOL;
    temperature = 25;
    fanSpeed = FAN_AUTO;

    
    if (outdoor >= 22 && outdoor <= 23 && aircond_intake >= 23 && outdoor < 100 && aircond_intake < 100 && outdoor != 127 && aircond_intake != 127) {
      temperature = 24;
    } else if (outdoor >= 24 && outdoor <= 25 && aircond_intake >= 23 && outdoor < 100 && aircond_intake < 100 && outdoor != 127 && aircond_intake != 127) {
      temperature = 23;  
    } else if (outdoor >= 26 && outdoor <= 27 && aircond_intake >= 23 && outdoor < 100 && aircond_intake < 100 && outdoor != 127 && aircond_intake != 127) {
      temperature = 22;  
    } else if (outdoor >= 28 && outdoor <= 29 && aircond_intake >= 23 && outdoor < 100 && aircond_intake < 100 && outdoor != 127 && aircond_intake != 127) {
      temperature = 21;    
    } else if (outdoor >= 30 && aircond_intake >= 23 && outdoor < 100 && aircond_intake < 100 && outdoor != 127 && aircond_intake != 127) {
      temperature = 20;    
    }
  ...
  // Utility room is hot, as the laundry drier has been running
    ...
    } else if (utility >= 27 && outdoor >= 20 && utility < 100 && outdoor < 100 && outdoor != 127) {
  ...
  // Kitchen is hot, as the oven has been running
    ...
    } else if (kitchen >= 27 && outdoor >= 20 && kitchen < 100 && outdoor < 100 && kitchen != 127 && outdoor != 127) {
      // COOL with AUTO FAN, +24
      operatingMode = MODE_COOL;
      temperature = 24;
      fanSpeed = FAN_AUTO;
...
void alarmHouseHeatDrop()   
{
 ...
 // Log sensor temperatures
      ...
      if ((owbuses[3].temperature != DEVICE_DISCONNECTED) && owbuses[3].temperature > -100 && owbuses[3].temperature < 100 && owbuses[5].temperature != 127) {
          JuliaBedroomTemp = owbuses[3].temperature;
         } else {
        JuliaBedroomTemp = JuliaBedroomTemp;
         }
      if ((owbuses[4].temperature != DEVICE_DISCONNECTED) && owbuses[4].temperature > -100 && owbuses[4].temperature < 100  &&owbuses[4].temperature != 127) {
          masterBedroomTemp = owbuses[4].temperature;
         } else {
        masterBedroomTemp = masterBedroomTemp;
        }
      if ((owbuses[5].temperature != DEVICE_DISCONNECTED) && owbuses[5].temperature > -100 && owbuses[5].temperature < 100 && owbuses[5].temperature != 127) {
 ...
 if (outdoor  >= HouseHeatOff && outdoor < 60) {// outdoor
   ...
   } else if(HouseHeatFissioState == HIGH && JuliaBedroomTemp >= 18  && warehouseTemp >= 7 && masterBedroomTemp >= 18 && JuliaBedroomTemp < 100 && masterBedroomTemp && warehouseTemp < 100 && JuliaBedroomTemp != 127 && masterBedroomTemp != 127 && warehouseTemp != 127) {
    houseHeatState = false;
    digitalWrite(HOUSE_HEAT_RELAY_PIN, LOW);
    Serial.println("house heat state OFF");

  // if Fissio heat goes to a on  - house heat on
   } else if (HouseHeatFissioState == LOW && outdoor <= HouseHeatOn || JuliaBedroomTemp  <= 19 || warehouseTemp <= 8 || masterBedroomTemp <= 19 && JuliaBedroomTemp < 100 && masterBedroomTemp && warehouseTemp < 100 && JuliaBedroomTemp != 127 && masterBedroomTemp != 127 && warehouseTemp != 127 ) {
