...
const long maxRpm               = 14000;   // The last LED's light up at 14000 RPM
const long maxRpmLimitter       = 14000;   // The motor RPM limiter up at 14000 RPM
const long okRpm                = 12000;   // The ok 12000 RPM
const long blinkRpm             = 11500;   // The blinking starts at 11500 RPM -> shift lights
const long egtHot               = 590;     // The EGT hot         600°C
const long choke                = 700;     // The Choke           700°C
const long ingnitionStop        = 620;     // The ingnition stop  620°C 
